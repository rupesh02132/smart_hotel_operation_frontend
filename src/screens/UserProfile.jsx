...
import { updateAvatar } from "../state/auth/Action";
        ...
        <Card className="max-w-6xl mx-auto overflow-hidden border-none shadow-[0_0_80px_-20px_rgba(0,0,0,0.5)] rounded-[3rem] bg-[#1e293b]/50 backdrop-blur-2xl border border-white/5">
          <CardContent className="p-0">
            <Row className="g-0">
              ...
              <Col
                lg={4}
                className="bg-gradient-to-b from-[#0f172a] to-[#1e293b] p-12 text-white flex flex-col items-center border-r border-white/5"
              >
                <div className="relative mb-8">
                  ...
                  >
                    {auth?.avatar ? (
                      ...
                      <span className="w-15 h-15 rounded-full object-cover">
                ...
                <Typography
                  variant="h4"
                  className="font-black mb-1 tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400"
                >
                  {profile.firstname}
                </Typography>
              ...
              <Col lg={8} className="p-10 md:p-16 bg-white shadow-inner">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                  {[
                    ...
                    <Box
                      key={i}
                      className={`${stat.bg} p-6 rounded-[2rem] border border-transparent hover:border-slate-200 transition-all`}
                    >
                    ...
                    <div className="flex items-center justify-between p-6 rounded-3xl bg-slate-900 text-white shadow-xl">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-bold italic text-blue-50">
                            21°C Optimized
                          </p>
                        </div>
                      </div>
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div>
                    <Typography className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2">
                      Guest Email
                    </Typography>
                    <Typography className="text-slate-700 font-semibold">
                      {profile.email}
                    </Typography>
                  </div>
                  <div>
